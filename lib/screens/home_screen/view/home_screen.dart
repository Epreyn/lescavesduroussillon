...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final customAppBarController = Get.put(
      CustomAppBarController(),
      tag: 'custom-app-bar-controller',
      permanent: true,
    );
    HomeScreenController cc = Get.put(HomeScreenController());
    ...
    return Scaffold(
      ...
      drawer: customAppBarController.buildDrawer(),
      body: _buildBody(cc),
    );
  }
  ...
  Widget _buildAnimatedTextSection(HomeScreenController cc) {
    return Obx(() {
      ...
      final name = (idx < list.length) ? list[idx].domainName : '';
          ...
          children: [
            ...
            !cc.pinned.value
                ? CustomAnimation(
                  ...
                  isOpacity: true,
                  xStartPosition: UniquesControllers().data.baseSpace * 2,
                  child: Padding(
    ...
    return Obx(() {
      ...
      return Positioned(
        ...
        child: CustomAnimation(
          ...
          duration: UniquesControllers().data.baseDurationWithMultiplier(4),
          delay: UniquesControllers().data.baseDelayWithMultiplier(12),
          yStartPosition: UniquesControllers().data.baseSpace * 4,
          child: Center(
            child: SizedBox(
